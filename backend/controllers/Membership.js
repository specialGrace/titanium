...
const createMember = asyncHandler(async (req, res) => {
  ...
  const memberExist = await Membership.findOne({ email: email });
  if (memberExist) {
    throw new Error("Email already exist, you have a member account already");
  }
